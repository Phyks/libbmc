...
latex_documents = [
  (master_doc, 'LibBMC.tex', 'LibBMC Documentation',
   'Phyks (Lucas Verney)', 'manual'),
]
...
man_pages = [
    (master_doc, 'libbmc', 'LibBMC Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'LibBMC', 'LibBMC Documentation',
   author, 'LibBMC', 'One line description of project.',
   'Miscellaneous'),
]
